"""Evaluate GhostNet baseline checkpoints on LiteJam task splits."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate GhostNet baseline checkpoint")
...
def main() -> None:
    ...
    model_cfg = GhostNetBaselineConfig(**model_cfg_dict)
    model = GhostNetBaseline(model_cfg)
