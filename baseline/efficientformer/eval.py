"""Evaluate EfficientFormer-L1 baseline checkpoints on LiteJam task splits."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate EfficientFormer-L1 baseline checkpoint")
...
def main() -> None:
    ...
    model_cfg = EfficientFormerL1BaselineConfig(**model_cfg_dict)
    model = EfficientFormerL1Baseline(model_cfg)
