"""Evaluate ResNet18 baseline checkpoints on LiteJam task splits."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate ResNet18 baseline checkpoint")
...
def main() -> None:
    ...
    model_cfg = ResNet18BaselineConfig(**model_cfg_dict)
    model = ResNet18Baseline(model_cfg)
