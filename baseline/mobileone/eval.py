"""Evaluate MobileOne-S0 baseline checkpoints on LiteJam task splits."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate MobileOne-S0 baseline checkpoint")
...
def main() -> None:
    ...
    model_cfg = MobileOneS0BaselineConfig(**model_cfg_dict)
    model = MobileOneS0Baseline(model_cfg)
